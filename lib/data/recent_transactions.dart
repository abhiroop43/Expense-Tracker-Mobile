...
class RecentTransactions {
  ...
  List<Transaction> searchTransactions(String searchQuery) {
    var allTransactions = getRecentTransactions();
    ...
    return allTransactions
        .where(
          (trn) =>
              trn.description.toLowerCase().contains(searchQuery.toLowerCase()),
        )
        .toList();
  }
